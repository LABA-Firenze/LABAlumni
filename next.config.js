...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/dashboard/docente', destination: '/pannello/docente', permanent: true },
      { source: '/dashboard/teacher', destination: '/pannello/docente', permanent: true },
      ...
      { source: '/saved-jobs', destination: '/annunci/salvati', permanent: true },
