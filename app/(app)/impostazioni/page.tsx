    ...
    <div className="max-w-7xl mx-auto pb-12">
      <header className="mb-8">
        ...
        <p className="text-gray-600 mt-1">
          Configura account, privacy, notifiche e gestione dati in un unico pannello.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
        <div className="xl:col-span-8 space-y-6">
          <Card variant="elevated" className="p-7">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Profilo e privacy</h2>
                <p className="text-sm text-gray-500">Identita pubblica e visibilita dei dati.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 pb-6 border-b border-gray-100">
              ...
              <div>
                <p className="font-semibold text-gray-900">{fullName || user?.email?.split('@')[0] || 'Utente'}</p>
                <p className="text-sm text-gray-500">{user?.email}</p>
                <p className="text-xs text-gray-400 mt-2">Foto profilo: JPG, PNG, WebP o GIF (max 5MB).</p>
              </div>
            </div>

            <div className="grid md:grid-cols-2 gap-5 pt-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Visibilita profilo</label>
                <select
              ...
              <label className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 bg-gray-50/70 mt-7 md:mt-0">
                <input
                  type="checkbox"
          ...
          {userRole && userRole !== 'admin' && (
            <Card variant="elevated" className="p-7 border-red-100 bg-red-50/30">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Verranno rimossi in modo permanente profilo, messaggi e dati associati.
              </p>
              {userRole === 'student' && (
                <div className="p-4 rounded-xl bg-amber-50 border border-amber-200 mb-4">
                  <p className="text-sm text-amber-800">
                    <strong>Studenti LABA:</strong> con login Logos, riaccedendo con le stesse credenziali verrai registrato nuovamente.
                  </p>
                </div>
              )}
        ...
        <aside className="xl:col-span-4 space-y-6">
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                />
                <span className="text-sm text-gray-700">Nuovi messaggi</span>
              </label>
              <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                />
                <span className="text-sm text-gray-700">Aggiornamenti candidature</span>
              </label>
              <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                />
                <span className="text-sm text-gray-700">Richieste connessione</span>
              </label>
              <label className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500"
                />
                <span className="text-sm text-gray-700">Commenti sui post</span>
              </label>
            </div>
          </Card>

          <Card variant="elevated" className="p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Dati personali (GDPR)</h2>
          ...
          <Card variant="elevated" className="p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Tour guidato</h2>
            <Button variant="outline" onClick={handleResetTour} className="w-full">
          ...
          <Card variant="elevated" className="p-5 sticky top-24">
            <Button variant="primary" onClick={save} disabled={saving} className="w-full rounded-xl">
